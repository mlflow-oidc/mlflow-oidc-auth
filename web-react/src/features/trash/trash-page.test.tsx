...
describe("TrashPage", () => {
    ...
    const mockExperiments = [
        { experiment_id: "exp1", name: "Exp 1", creation_time: 1000, last_update_time: 2000 },
        { experiment_id: "exp2", name: "Exp 2", creation_time: 3000, last_update_time: 4000 },
    ];

    const mockRuns = [
        { run_id: "run1", run_name: "Run 1", start_time: 1000, end_time: 2000, experiment_id: "exp1" },
    ];
    ...
    it("handles restoring an item", async () => {
        ...
        expect(mockShowToast).toHaveBeenCalledWith(expect.stringContaining("restored"), "success");
