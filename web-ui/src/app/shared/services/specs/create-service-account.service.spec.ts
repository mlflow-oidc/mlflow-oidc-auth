...
describe('CreateServiceAccountService', () => {
  ...
  it('should open the modal and return afterClosed observable', () => {
    const data: CreateServiceAccountModalData = { title: 'Create', username: 'svc', display_name: 'svc', is_admin: false, is_service_account: true };
    const result: CreateServiceAccountModalResult = { username: 'svc', display_name: 'svc', is_admin: false, is_service_account: false };
