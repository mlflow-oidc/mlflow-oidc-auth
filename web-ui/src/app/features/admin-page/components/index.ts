...
export * from "./details/prompt-permission-details/prompt-permission-details.component";
...
export * from "./permissions/prompt-permissions/prompt-permissions.component";
