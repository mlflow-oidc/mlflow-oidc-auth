...
describe("PromptPermissionDetailsComponent", () => {
      ...
      providers: [
        provideHttpClient(),
        {
          ...
          useValue: {
            ...
            snapshot: {
              paramMap: { get: (key: string) => (key === "id" ? "test-id" : null) },
            },
          },
        },
  ...
  it("should revoke permission for user", () => {
    ...
    expect(permissionDataService.deletePromptPermission).toHaveBeenCalledWith({ name: "test-id", username: "user1" });
  ...
  it("should edit permission for user", () => {
    ...
    expect(permissionDataService.updatePromptPermission).toHaveBeenCalledWith({ name: "test-id", permission: PermissionEnum.EDIT, username: "user1" });
  ...
  it("should add user", () => {
    ...
    permissionModalService.openGrantPermissionModal.mockReturnValue(of({ entity: { id: "0user2", name: "user2" }, permission: PermissionEnum.EDIT }));
  ...
  it("should add service account", () => {
    ...
    permissionModalService.openGrantPermissionModal.mockReturnValue(of({ entity: { id: "0svc2", name: "svc2" }, permission: PermissionEnum.READ }));
    permissionDataService.createPromptPermission.mockReturnValue(of({}));
