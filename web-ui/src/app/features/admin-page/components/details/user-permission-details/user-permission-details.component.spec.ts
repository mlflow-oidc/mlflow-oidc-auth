...
import { ExperimentsDataService, ModelsDataService, PromptsDataService, PermissionDataService, SnackBarService } from "src/app/shared/services";
...
describe("UserPermissionDetailsComponent", () => {
  ...
  beforeEach(async () => {
    expDataService = { getExperimentsForUser: jest.fn(), getAllExperiments: jest.fn() } as any;
    modelDataService = { getModelsForUser: jest.fn(), getAllModels: jest.fn() } as any;
  ...
  it("should load all data sources on ngOnInit", () => {
    ...
    const models = [{ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }];
    const prompts = [{ name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }];
  ...
  it("should add model permission to user", () => {
    modelDataService.getAllModels.mockReturnValue(of([
      {
        name: "model2",
        aliases: {},
        description: "",
    ...
    permissionModalService.openGrantPermissionModal.mockReturnValue(of({ entity: { id: "0", name: "model2" }, permission: PermissionEnum.EDIT }));
    permissionDataService.createModelPermission.mockReturnValue(of("created"));
    modelDataService.getModelsForUser.mockReturnValue(of([{ name: "model2", permission: PermissionEnum.EDIT, type: PermissionTypeEnum.USER }]));
    component.userId = "123";
    component.modelsDataSource = [{ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }];
    ...
    expect(permissionDataService.createModelPermission).toHaveBeenCalledWith({ username: "123", name: "model2", permission: PermissionEnum.EDIT });
    expect(modelDataService.getModelsForUser).toHaveBeenCalledWith("123");
  });

  it("should add experiment permission to user", () => {
    expDataService.getAllExperiments.mockReturnValue(of([
      { id: "exp2", name: "Experiment 2", tags: {}, permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }
    ]));
    permissionModalService.openGrantPermissionModal.mockReturnValue(of({ entity: { id: "exp2", name: "Experiment 2" }, permission: PermissionEnum.READ }));
    ...
    expDataService.getExperimentsForUser.mockReturnValue(of([
      { id: "exp2", name: "Experiment 2", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }
    ]));
    component.userId = "123";
    component.experimentsDataSource = [{ id: "exp1", name: "Experiment 1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }];
    component.addExperimentPermissionToUser();
    expect(expDataService.getAllExperiments).toHaveBeenCalled();
    expect(permissionModalService.openGrantPermissionModal).toHaveBeenCalled();
    expect(permissionDataService.createExperimentPermission).toHaveBeenCalledWith({ username: "123", experiment_name: "Experiment 2", permission: PermissionEnum.READ });
    expect(expDataService.getExperimentsForUser).toHaveBeenCalledWith("123");
  });
  ...
  it("should handle experiment actions", () => {
    ...
    const event = { action: { action: TableActionEnum.EDIT }, item: { id: "exp1", name: "Experiment 1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } };
    ...
    const event2 = { action: { action: TableActionEnum.REVOKE }, item: { id: "exp1", name: "Experiment 1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } };
  ...
  it("should revoke experiment permission for user (USER type)", () => {
    ...
    expDataService.getExperimentsForUser.mockReturnValue(of([
      { id: "exp1", name: "Experiment 1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }
    ]));
    component.userId = "123";
    component.revokeExperimentPermissionForUser({ id: "exp1", type: PermissionTypeEnum.USER });
    expect(permissionDataService.deleteExperimentPermission).toHaveBeenCalledWith({ experiment_id: "exp1", username: "123" });
  ...
  it("should not revoke experiment permission for user (non-USER type)", () => {
    snackBarService.openSnackBar.mockReturnValue({} as any);
    component.revokeExperimentPermissionForUser({ id: "exp1", type: PermissionTypeEnum.FALLBACK });
  ...
  it("should revoke model permission for user (USER type)", () => {
    ...
    snackBarService.openSnackBar.mockReturnValue({} as any);
    modelDataService.getModelsForUser.mockReturnValue(of([{ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }]));
    component.userId = "123";
    component.revokeModelPermissionForUser({ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } as any);
    expect(permissionDataService.deleteModelPermission).toHaveBeenCalledWith({ name: "model1", username: "123" });
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Permission revoked successfully");
    expect(modelDataService.getModelsForUser).toHaveBeenCalledWith("123");
  });
  ...
  it("should not revoke model permission for user (non-USER type)", () => {
    snackBarService.openSnackBar.mockReturnValue({} as any);
    component.revokeModelPermissionForUser({ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.FALLBACK } as any);
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Nothing to reset");
  });
  ...
  it("should handle model actions", () => {
    ...
    const event = { action: { action: TableActionEnum.EDIT }, item: { name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } };
    ...
    const event2 = { action: { action: TableActionEnum.REVOKE }, item: { name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } };
  ...
  it("should handle edit user permission for model (FALLBACK type)", () => {
    ...
    modelDataService.getModelsForUser.mockReturnValue(of([{ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }]));
    component.userId = "123";
    component.handleEditUserPermissionForModel({ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.FALLBACK } as any);
    expect(permissionModalService.openEditPermissionsModal).toHaveBeenCalledWith("model1", "123", PermissionEnum.READ);
    expect(permissionDataService.createModelPermission).toHaveBeenCalledWith({ name: "model1", permission: PermissionEnum.EDIT, username: "123" });
  ...
  it("should handle edit user permission for model (USER type)", () => {
    ...
    modelDataService.getModelsForUser.mockReturnValue(of([{ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }]));
    component.userId = "123";
    component.handleEditUserPermissionForModel({ name: "model1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } as any);
    expect(permissionModalService.openEditPermissionsModal).toHaveBeenCalledWith("model1", "123", PermissionEnum.READ);
    expect(permissionDataService.updateModelPermission).toHaveBeenCalledWith({ name: "model1", permission: PermissionEnum.EDIT, username: "123" });
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Permissions updated successfully");
    expect(modelDataService.getModelsForUser).toHaveBeenCalledWith("123");
  });
  ...
  it("should handle edit user permission for experiment (FALLBACK type)", () => {
    ...
    component.userId = "123";
    component.handleEditUserPermissionForExperiment({ id: "exp1", name: "Experiment 1", permission: PermissionEnum.READ, type: PermissionTypeEnum.FALLBACK } as any);
    expect(permissionModalService.openEditPermissionsModal).toHaveBeenCalledWith("exp1", "123", PermissionEnum.READ);
    expect(permissionDataService.createExperimentPermission).toHaveBeenCalledWith({ experiment_id: "exp1", permission: PermissionEnum.EDIT, username: "123" });
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Permissions updated successfully");
    expect(expDataService.getExperimentsForUser).toHaveBeenCalledWith("123");
  });
  ...
  it("should handle edit user permission for experiment (USER type)", () => {
    ...
    component.userId = "123";
    component.handleEditUserPermissionForExperiment({ id: "exp1", name: "Experiment 1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } as any);
    expect(permissionModalService.openEditPermissionsModal).toHaveBeenCalledWith("exp1", "123", PermissionEnum.READ);
    expect(permissionDataService.updateExperimentPermission).toHaveBeenCalledWith({ experiment_id: "exp1", permission: PermissionEnum.EDIT, username: "123" });
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Permissions updated successfully");
    expect(expDataService.getExperimentsForUser).toHaveBeenCalledWith("123");
  });
  ...
  it("should handle prompt actions", () => {
    ...
    const eventPrompt = { action: { action: TableActionEnum.EDIT }, item: { name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } };
    ...
    const eventPrompt2 = { action: { action: TableActionEnum.REVOKE }, item: { name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } };
  ...
  it("should handle edit user permission for prompt (FALLBACK type)", () => {
    ...
    snackBarService.openSnackBar.mockReturnValue({} as any);
    promptDataService.getPromptsForUser.mockReturnValue(of([{ name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }]));
    component.userId = "123";
    component.handleEditUserPermissionForPrompt({ name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.FALLBACK } as any);
    expect(permissionModalService.openEditPermissionsModal).toHaveBeenCalledWith("prompt1", "123", PermissionEnum.READ);
    expect(permissionDataService.createPromptPermission).toHaveBeenCalledWith({ name: "prompt1", permission: PermissionEnum.EDIT, username: "123" });
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Permissions updated successfully");
    expect(promptDataService.getPromptsForUser).toHaveBeenCalledWith("123");
  });
  ...
  it("should handle edit user permission for prompt (USER type)", () => {
    ...
    promptDataService.getPromptsForUser.mockReturnValue(of([{ name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }]));
    component.userId = "123";
    component.handleEditUserPermissionForPrompt({ name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } as any);
    expect(permissionModalService.openEditPermissionsModal).toHaveBeenCalledWith("prompt1", "123", PermissionEnum.READ);
    expect(permissionDataService.updatePromptPermission).toHaveBeenCalledWith({ name: "prompt1", permission: PermissionEnum.EDIT, username: "123" });
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Permissions updated successfully");
    expect(promptDataService.getPromptsForUser).toHaveBeenCalledWith("123");
  });
  ...
  it("should revoke prompt permission for user (USER type)", () => {
    ...
    promptDataService.getPromptsForUser.mockReturnValue(of([{ name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER }]));
    component.userId = "123";
    component.revokePromptPermissionForUser({ name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.USER } as any);
    expect(permissionDataService.deletePromptPermission).toHaveBeenCalledWith({ name: "prompt1", username: "123" });
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Permission revoked successfully");
    expect(promptDataService.getPromptsForUser).toHaveBeenCalledWith("123");
  });
  ...
  it("should not revoke prompt permission for user (non-USER type)", () => {
    snackBarService.openSnackBar.mockReturnValue({} as any);
    component.revokePromptPermissionForUser({ name: "prompt1", permission: PermissionEnum.READ, type: PermissionTypeEnum.FALLBACK } as any);
    expect(snackBarService.openSnackBar).toHaveBeenCalledWith("Nothing to reset");
  });
  ...
  it("should handle tab selection", () => {
    ...
    expect(router.navigate).toHaveBeenCalledWith(["../prompts"], { relativeTo: activatedRoute });
  });
});
