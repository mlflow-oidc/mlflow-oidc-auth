export const API_URL = {
  ...
  CREATE_GROUP_EXPERIMENT_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/experiments/create",
  DELETE_GROUP_EXPERIMENT_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/experiments/delete",
  UPDATE_GROUP_EXPERIMENT_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/experiments/update",

  CREATE_GROUP_MODEL_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/registered-models/create",
  DELETE_GROUP_MODEL_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/registered-models/delete",
  UPDATE_GROUP_MODEL_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/registered-models/update",

  CREATE_GROUP_PROMPT_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/prompts/create",
  DELETE_GROUP_PROMPT_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/prompts/delete",
  UPDATE_GROUP_PROMPT_PERMISSION:
    "/api/2.0/mlflow/groups/${groupName}/prompts/update",
};
