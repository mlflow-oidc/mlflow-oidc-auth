...
class GatewayModelDefinitionGroupPermissionRepository(
    BaseGroupPermissionRepository[
        SqlGatewayModelDefinitionGroupPermission, GatewayModelDefinitionPermission
    ]
):
