...
class TestPromptOptimizationJobHandlers:
    ...
    def test_create_maps_to_update_experiment(self):
        ...
        assert (
            BEFORE_REQUEST_HANDLERS[CreatePromptOptimizationJob]
            is validate_can_update_experiment
        )

    def test_get_maps_to_read_experiment(self):
        """GetPromptOptimizationJob requires READ on experiment."""
        assert (
            BEFORE_REQUEST_HANDLERS[GetPromptOptimizationJob]
            is validate_can_read_experiment
        )

    def test_search_maps_to_read_experiment(self):
        """SearchPromptOptimizationJobs requires READ on experiment."""
        assert (
            BEFORE_REQUEST_HANDLERS[SearchPromptOptimizationJobs]
            is validate_can_read_experiment
        )
    ...
    def test_delete_maps_to_delete_experiment(self):
        ...
        assert (
            BEFORE_REQUEST_HANDLERS[DeletePromptOptimizationJob]
            is validate_can_delete_experiment
        )
    ...
    def test_cancel_maps_to_update_experiment(self):
        ...
        assert (
            BEFORE_REQUEST_HANDLERS[CancelPromptOptimizationJob]
            is validate_can_update_experiment
        )
