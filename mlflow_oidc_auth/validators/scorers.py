...
def _get_permission_from_scorer_name(username: str) -> Permission:
    ...
    return effective_scorer_permission(
        experiment_id=experiment_id, scorer_name=name, user=username
    ).permission
...
def _get_permission_from_scorer_permission_request(username: str) -> Permission:
    ...
    return effective_scorer_permission(
        experiment_id=experiment_id, scorer_name=scorer_name, user=username
    ).permission
